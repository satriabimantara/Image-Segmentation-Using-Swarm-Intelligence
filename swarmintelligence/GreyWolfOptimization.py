...
class GreyWolfOptimization(SwarmIntelligence):
    def __init__(self, k, wolfSize, maxIteration, fitness_function='otsu', obj='max', initial_solution=None):
        super(GreyWolfOptimization, self).__init__(initial_solution=initial_solution,
                                                   class_name='GreyWolfOptimization')
    ...
    def fit_run(self, image_array):
        super(GreyWolfOptimization, self).fit_run(image_array)
        ...
        return self.grey_wolf_optimization()

    def grey_wolf_optimization(self):
